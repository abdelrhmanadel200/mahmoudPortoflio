  ...
  return (
    <div id="contact" className="glass rounded-2xl p-6 sm:p-8 animate-blur-in" style={{ animationDelay: '0.6s' }}>
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-2 sm:flex sm:flex-wrap sm:items-center gap-3 sm:gap-5">
          <a
          ...
          >
            <div className="w-9 h-9 rounded-lg bg-teal-500/10 border border-teal-500/20 flex items-center justify-center group-hover:bg-teal-500/20 transition-colors flex-shrink-0">
              <Phone className="w-4 h-4 text-teal-400" />
            </div>
            <span className="text-xs truncate">+20 155 219 9188</span>
          </a>
          ...
          >
            <div className="w-9 h-9 rounded-lg bg-green-500/10 border border-green-500/20 flex items-center justify-center group-hover:bg-green-500/20 transition-colors flex-shrink-0">
          ...
          <div className="flex items-center gap-2 text-sm text-slate-300">
            ...
            <span className="text-xs">Giza, Egypt</span>
          </div>
